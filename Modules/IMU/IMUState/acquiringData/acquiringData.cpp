...
void acquiringData::calibrate (I2CInterfaceHandler * interface, 
NonBlockingDelay * refresh) {
...
void acquiringData::promAcumulatedMeasurement() {
    this->samplesCounter++;
    this->aAccumlated [0] += (this->a[0] - this->aAccumlated [0]) / this->samplesCounter;
    this->aAccumlated [1] += (this->a[1] - this->aAccumlated [1]) / this->samplesCounter;
    this->aAccumlated [2] += (this->a[2] - this->aAccumlated [2]) / this->samplesCounter;

    this->gAccumlated [0] += (this->g[0] - this->gAccumlated [0]) / this->samplesCounter;
    this->gAccumlated [1] += (this->g[1] - this->gAccumlated [1]) / this->samplesCounter;
    this->gAccumlated [2] += (this->g[2] - this->gAccumlated [2]) / this->samplesCounter;

    this->mAccumlated [0] += (this->m[0] - this->mAccumlated [0]) / this->samplesCounter;
    this->mAccumlated [1] += (this->m[1] - this->mAccumlated [1]) / this->samplesCounter;
    this->mAccumlated [2] += (this->m[2] - this->mAccumlated [2]) / this->samplesCounter;

    this->anglesAccumlated [0] += (this->rpy[0] - this->anglesAccumlated [0]) / this->samplesCounter;
    this->anglesAccumlated [1] += (this->rpy[1] - this->anglesAccumlated [1]) / this->samplesCounter;
    this->anglesAccumlated [2] += (this->rpy[2] - this->anglesAccumlated [2]) / this->samplesCounter;

    this->temperatureAccumlated  += (this->temperature - this->temperatureAccumlated ) / this->samplesCounter;
}
